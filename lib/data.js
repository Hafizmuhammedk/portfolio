...
export const experience = [
  {
    ...
    description:
      'Lead architecture development for large-scale LLM deployments. Optimized inference latency by 40% using custom caching mechanisms.',
  },
  {
    period: '2020 — 2022',
    role: 'SYSTEMS ARCHITECT',
    description:
      'Designed distributed microservices for real-time data processing. Managed cloud infrastructure across AWS and GCP environments.',
  },
  {
    period: '2018 — 2020',
    role: 'BACKEND DEVELOPER',
    description:
      'Built robust API endpoints and optimized database queries for a high-traffic financial technology platform.',
  },
];
...
export const technologyCards = [
  {
    ...
    items: ['Python', 'MicroPython'],
    capabilities: [
      'Production AI APIs and workflow automation',
      'ESP32 and ESP8266 firmware development',
    ],
  },
  {
    name: 'FRAMEWORKS',
